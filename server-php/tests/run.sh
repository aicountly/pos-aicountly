#!/usr/bin/env bash
# Run the POS integration tests against a throwaway PostgreSQL database and a
...
DB_NAME="${TEST_DB_NAME:-pos_test}"
DB_USER="${TEST_DB_USER:-pos_test}"
DB_PASS="${TEST_DB_PASS:-pos_test}"
