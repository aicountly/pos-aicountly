...
$pdo->exec(
    'CREATE TABLE IF NOT EXISTS pos_sql_migrations (
...
$applied = [];
foreach (Db::all('SELECT filename, checksum FROM pos_sql_migrations') as $row) {
...
foreach ($files as $path) {
    ...
    try {
        ...
        $stmt = $pdo->prepare('INSERT INTO pos_sql_migrations (filename, checksum) VALUES (:f, :c)');
