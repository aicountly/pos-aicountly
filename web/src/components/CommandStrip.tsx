...
function describe(command: IntegrationCommand): string {
  ...
  const what: Record<string, string> = {
    'pos.sale.invoice': 'Recording the sale in Books',
    'pos.sale.stock_issue': 'Taking the goods out of stock',
    'pos.return.receipt': 'Putting the goods back in stock',
    'pos.return.credit_note': 'Raising the credit note',
  }
