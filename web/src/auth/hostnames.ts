 ...
 * pos.aicountly.com and pos.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'pos').trim() || 'pos'
...
/**
 * `pos.aicountly.com` and `pos.gh.aicountly.com` both resolve to
 * `pos`, which is what the portal expects in authentication_jump.
 */
