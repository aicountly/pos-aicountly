...
export function DonutChart({
  ...
  return (
    <div className="pos-donut">
      <svg viewBox="0 0 140 140" role="img" aria-labelledby={titleId} className="pos-donut__ring">
        <title id={titleId}>{caption}</title>
        ...
        <text className="pos-donut__figure" x="70" y="68" textAnchor="middle">
          {centreValue}
        </text>
        <text className="pos-donut__caption" x="70" y="86" textAnchor="middle">
          {centreLabel}
        </text>
      </svg>
