    ...
    >
      ...
      <div className="pos-service__panel">
        ...
        <div className="pos-actions">
          <Link className="pos-button pos-button--small pos-button--secondary" to="/till">
            Open the till
          </Link>
...
export function RestaurantQuickActions() {
  ...
  const actions: QuickAction[] = [
    ...
    { id: 'new-order', label: 'New order', icon: <ScanLine size={18} aria-hidden />, to: '/till', permissions: ['sell'] },
